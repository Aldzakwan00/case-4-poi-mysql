...
$check_query = "SELECT * FROM POI WHERE Koordinat_Latitude='$latitude' AND Koordinat_Longitude='$longitude'";
...
if (mysqli_num_rows($check_result) > 0) {
    ...
    $sql = "INSERT INTO POI (Koordinat_Latitude, Koordinat_Longitude, Nama_Lokasi, Deskripsi_Lokasi, Rating, Kategori, Waktu_Buka, Kontak_Lokasi) VALUES ('$latitude', '$longitude', '$nama_lokasi', '$deskripsi_lokasi', '$rating', '$kategori', '$waktu_buka', '$kontak_lokasi')";
